...
太久没更新了。先说一下明天的计划。先在course hero上买一下哪个tutorial，看看可不可以参考，不行的话就把inverter那一章看完就直接去做project，然后看一下模拟layout设计。
...
好久没有写东西了，感觉是要update一下。我看了一下上周的东西，还是要一定的关联了，但是目前做的东西又和之前很不一样。现在是做非常前端的一些研究，其实就是研究如何去用tcad去搭建cfet的模型，然后用这个的sram去比较finfet的sram性能。目前是基本学了一下半导体物理和器件，其实其中的问题还是很多的，但是我觉得我的中心应该还是要放在学习tcad的软件上，然后如果有什么问题就边看边学，这样子效率就会高很多。目前是要学习gaa和cfet的搭建，学习完应该差不多就可以有一个东西可以去做了。还有一个我有点担心的点是其实工艺也是很重要的，但是我现在一直没有时间去学习，就有点恼火和烦躁。但是其实那个何同学的视频说的还是对的，就是要接受不完美的自己，然后先让自己动和做起来，再考虑其他的，加油！感觉自己再慢慢步入正轨。
